...
// Helper function to fetch errors from the mbzeguard command
async function getmbzeguardErrors() {
    return new Promise(resolve => {
        safeExec('/usr/bin/mbzeguard', ['check_logs'], 'P0_PRIORITY', result => {
...
async function checkForCriticalErrors() {
    try {
        const errors = await getmbzeguardErrors();
