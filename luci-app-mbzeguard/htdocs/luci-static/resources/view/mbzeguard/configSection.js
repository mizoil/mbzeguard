...
function createConfigSection(section, map, network) {
    ...
    o = s.taboption('basic', form.DynamicList, 'community_lists', _('Service List'), _('Select predefined service for routing') + ' <a href="https://github.com/mizoil/allow-domains" target="_blank">github.com/mizoil/allow-domains</a>');
