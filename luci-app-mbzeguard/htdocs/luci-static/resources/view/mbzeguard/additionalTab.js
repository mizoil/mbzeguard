...
function createAdditionalSection(mainSection, network) {
    ...
    o = mainSection.taboption('additional', form.Value, 'procd_reload_delay', _('Interface Monitoring Delay'), _('Delay in milliseconds before reloading mbzeguard after interface UP'));
    o.ucisection = 'main';
    o.depends('mon_restart_ifaces', '1');
    o.default = '2000';
    o.rmempty = false;
    ...
    o = mainSection.taboption('additional', form.Flag, 'dont_touch_dhcp', _('Dont touch my DHCP!'), _('mbzeguard will not change the DHCP config'));
    o.default = '0';
    o.rmempty = false;
    o.ucisection = 'main';
