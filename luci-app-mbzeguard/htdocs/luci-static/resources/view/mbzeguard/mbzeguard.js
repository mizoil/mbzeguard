...
'require form';
'require network';
'require view.mbzeguard.configSection as configSection';
'require view.mbzeguard.diagnosticTab as diagnosticTab';
'require view.mbzeguard.additionalTab as additionalTab';
    ...
    async render() {
        document.head.insertAdjacentHTML('beforeend', `
            <style>
                ...
                #cbi-mbzeguard:has(.cbi-tab-disabled[data-tab="basic"]) #cbi-mbzeguard-extra {
                    display: none;
                }
            </style>
        `);

        const m = new form.Map('mbzeguard', _(''), null, ['main', 'extra']);
