...
main() {
    ...
    if [ -f "/etc/init.d/mbzeguard" ]; then
        printf "\033[32;1mmbzeguard is already installed. Just upgrade it? (y/n)\033[0m\n"
        printf "\033[32;1my - Only upgrade mbzeguard\033[0m\n"
    ...
    while true; do
        ...
        case $RUS in
        y)
            opkg install $DOWNLOAD_DIR/luci-i18n-mbzeguard-ru*.ipk
            break
            ;;
    ...
    rm -f $DOWNLOAD_DIR/mbzeguard*.ipk $DOWNLOAD_DIR/luci-app-mbzeguard*.ipk $DOWNLOAD_DIR/luci-i18n-mbzeguard-ru*.ipk
...
add_tunnel() {
    ...
    while true; do
        ...
        2)
            ...
            printf "\e[1;32mUse these instructions to manual configure https://github.com/mizoil/mbzeguard/\e[0m\n"
            fi
        ...
        4)
            ...
            printf "\e[1;32mUse these instructions to configure https://github.com/mizoil/mbzeguard/\e[0m\n"
            break
            ;;
