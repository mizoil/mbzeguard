...
## Common
mbzeguard_CONFIG="/etc/config/mbzeguard"
RESOLV_CONF="/etc/resolv.conf"
DNS_RESOLVERS="1.1.1.1 1.0.0.1 8.8.8.8 8.8.4.4 9.9.9.9 9.9.9.11 94.140.14.14 94.140.15.15 208.67.220.220 208.67.222.222 77.88.8.1 77.88.8.8"
CHECK_PROXY_IP_DOMAIN="ip.mbzeguard.fyi"
FAKEIP_TEST_DOMAIN="fakeip.mbzeguard.fyi"
...
## nft
NFT_TABLE_NAME="mbzeguardTable"
NFT_LOCALV4_SET_NAME="localv4"
NFT_COMMON_SET_NAME="mbzeguard_subnets"
NFT_DISCORD_SET_NAME="mbzeguard_discord_subnets"
...
## Lists
GITHUB_RAW_URL="https://raw.githubusercontent.com/mizoil/allow-domains/main"
SRS_MAIN_URL="https://github.com/mizoil/allow-domains/releases/latest/download"
